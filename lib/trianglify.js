...
var defaults = {
  ...
  cell_padding: 10,                 // Amount of padding used to generate a randomized grid
...
function Trianglify(opts) {
  ...
  var gradient = _get_2d_gradient(opts.x_colors, opts.y_colors);
  ...
  **********************************************************/
  ...
  function _get_2d_gradient(x_colors, y_colors) {
    var x_color = chroma.scale(x_colors).mode(opts.color_space);
    var y_color = chroma.scale(y_colors).mode(opts.color_space);
